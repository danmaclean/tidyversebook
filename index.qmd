...
```{r, echo=FALSE, fig.cap = "A significant pain in the ..."}
knitr::include_graphics("assets/matador.jpg")
```
...
```{r, echo=FALSE, fig.cap="A smaller pain in the ..."}
knitr::include_graphics("assets/baby_bull.jpg")
```
